...
async function GetMonthlyReport(): Promise<MonthlyReportResponse> {
  const response = await api(
    'monthly-summary/077c7886-2afa-4719-b675-6cacd486e207',
    {
      next: {
  ...
  const team: { monthlySummary: MonthlyReportResponse } = await response.json()
  return team.monthlySummary
}
